...
void WorldSession::HandleMessagechatOpcode(WorldPacket& recvData)
{
    ...
    switch (type)
    {
        ...
        case CHAT_MSG_WHISPER:
        {
            ...
            if (!receiver || (!receiver->isAcceptWhispers() && !sender->IsGameMaster() && receiver->GetSession()->HasPermission(RBAC_PERM_CAN_FILTER_WHISPERS) && !receiver->IsInWhisperWhiteList(sender->GetGUID())))
            {
                SendPlayerNotFoundNotice(to);
                return;
            }
